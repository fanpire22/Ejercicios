...
public class AKM : WeaponBase
{
    ...
    private void Awake()
    {
        _rayOrigin = transform.Find("RifleMuzzle");
        base.AddAmmo(1000);
    }

    /// <summary>
    /// Golpeamos a un máximo de dos objetos desde el rayo. Si es físico, le damos una fuerza para moverlo. 
    /// Si es damageable, lo dañamos
    /// </summary>
